...
namespace Util
{
    // adapted from https://github.com/rabidgremlin/LetterBoxer
    // found in article https://tonysgiang.blogspot.com/2021/09/a-better-way-to-get-letterboxing-in.html
    ...
    {    
        ...
        private Camera cam;
        [SerializeField] private Camera letterBoxerCamera;
        ...
        {
            if (letterBoxerCamera != null) return;
        ...
        private void PerformSizing()
        {
            ...
            if (referenceMode == LetterBoxing.ReferenceMode.OrginalResolution)
            {
